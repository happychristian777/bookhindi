      ...
      <div class='order-info-content'>
        ...
        <table class='order-table'>
          <tbody>
            <tr>
              ...
              <td>
                <br> <span class='thin'>Punjabi Mock Test</span>
        ...
        <div class='credit-info'>
          <div class='credit-info-content'>
            ...
            <form class="form" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>User/check_pm_punjabi" id="paymentFrm" >
