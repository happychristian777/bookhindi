...
<h2><center>NAATI CCL Practise Test Material - Hindi</center></h2><br>
      ...
      <div class="col-lg-3">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
           ...
           <a href="<?php echo base_url();?>User/load_hindi_vocab?name=HINDI VOCABULARY" class="btn btn-block btn-primary text-uppercase">View</a>
        ...
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
                ...
                <li><span class="fa-li"><i class="fas fa-check"></i></span>Translation provided from Hindi to English</li>
                <li><span class="fa-li"><i class="fas fa-check"></i></span>Translation provided from English to Hindi</li>
            ...
            <a href="<?php echo base_url();?>User/load_hindi_pm1?name=Practise Material 1" class="btn btn-block btn-primary text-uppercase">View</a>
         </form>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <a href="<?php echo base_url();?>User/load_hindi_pm2?name=Practise Material 2" class="btn btn-block btn-primary text-uppercase">View</a>
      ...
      <div class="col-lg-3">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <a href="<?php echo base_url();?>User/load_hindi_pm3?name=Practise Material 3" class="btn btn-block btn-primary text-uppercase">View</a>
