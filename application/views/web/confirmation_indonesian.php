		...
		<div class="container py-lg-5">
			<div class="feature-1-content">
							...
							<div class="read">
							    ...
							    <form method="post" action="<?php echo base_url();?>User/load_checkout_pm_indonesian">
        <input type="hidden" name="calc" value="20">
        <input type="hidden" name="item_name" value="<?php echo $name; ?>"> 
        <p>Gujarati Mock Test</p>
        <input type="submit" style="background:#400082;" class="btn btn-success btn-block" data-dismiss="modal" value="Confirm: $20">
         </form><br>
         <form method="post" action="<?php echo base_url();?>User/bypass_pm_indonesian">
         <input type="submit" style="" class="btn btn-danger btn-block" data-dismiss="modal" value="Already paid ? Click here"> 
