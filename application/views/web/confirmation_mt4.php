		...
		<div class="container py-lg-5">
			<div class="feature-1-content">
                ...
                <p class="mt-2" style="text-align:justify;"><b>3.	Take pen and notebook before you begin this test.</p>
                 <p class="mt-2" style="text-align:justify;"><b>4.	The disturbance in the background has add purposely in order to make the test more tough for test takers.</p>
...
<div class="row" >
    <div class="mx-auto">
      <div class="sub-text text-center">
        ...
        <form method="post" action="<?php echo base_url();?>User/bypass_mt4">
