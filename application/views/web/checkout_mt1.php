...
<div class="checkout">
 <h1>Checkout</h1>
  <form class="form" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>User/check_mt1" id="paymentFrm" >


  <input type="hidden" name="item_name" value="<?php echo $item_name;?>">
  <input type="hidden" name="item_price" value="<?php echo number_format($item_amount);?>00">

  <label for="card-number">Test Name: MOCK Test 1</label><br>
  <label for="card-number">Total Amount: $15</label>
  <fieldset>
    ...
    <strong>Test Result will be available for 24 hours per payment</strong>
    </center>
  </form>
</div>
