...
<div class="checkout">
 <h1>Checkout</h1>
  <form class="form" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>User/check_mt5" id="paymentFrm" >
  ...
  <fieldset>
    ...
    <strong>Mocktests will be available for 24 hours per payment</strong>
    </center>
  </form>
</div>
